...
#define MEM_TASK_BASE        (0x80000000)        // 进程起始地址空间
#define MEM_TASK_STACK_TOP 0xE0000000
#define MEM_TASK_ARG_SIZE (1024*4)
#define MEM_TASK_STACK_SIZE (MEM_PAGE_SIZE * 128)
...
uint32_t memory_get_paddr(uint32_t paddr, uint32_t vaddr);
